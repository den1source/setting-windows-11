...
4. **Pro или LTSC** - по сути, после настроек вы получаете из Pro - LTSC и по плавности и по скорости работы. LTSC это таже самая Pro но с минимумом приложений и с настройками на уменьшение занимаемой памяти (см. пункт "Если места слишком мало").
